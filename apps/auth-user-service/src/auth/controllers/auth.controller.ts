...
export class AuthController {
   ...
   * - NOTE: /api/auth/* does NOT go through Nginx auth_request
   * - Therefore, we MUST use Guard to protect this endpoint
   * - Supports logout from current device (with deviceId) or all devices
   */
  ...
  async logout(
    ...
    const userId = req.user.userId; // Get userId from JWT payload (verified by JwtStrategy)
